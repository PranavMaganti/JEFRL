...
class Visitor:
    ...
    """
    def __call__(self, obj, metadata): # -> Any | Object:
        ...
    ...
    def visit_list(self, obj): # -> Generator[Unknown | Visited, Any, None]:
        ...
    
    visit_Array = ...
    def visit_dict(self, obj): # -> Generator[Unknown | Visited, Any, None]:
        ...
...
class ReprVisitor(Visitor):
    ...
    def visit_RecursionError(self, obj): # -> Generator[Visited, Any, None]:
        ...
    
    def visit_Object(self, obj): # -> Generator[Unknown | Visited, Unknown, None]:
        ...
    
    def visit_Generic(self, obj): # -> Generator[Visited, Any, None]:
        ...
    
    def visit_list(self, obj): # -> Generator[Unknown | Visited, Unknown, None]:
        ...
    
    visit_Array = ...
    def visit_dict(self, obj): # -> Generator[Unknown | Visited, Unknown, None]:
        ...
    
    if PY3:
        def visit_str(self, obj): # -> Generator[Visited, Any, None]:
            ...
        
    else:
        def visit_unicode(self, obj): # -> Generator[Visited, Any, None]:
            ...
        
    def visit_SourceLocation(self, obj): # -> Generator[Unknown, Any, None]:
        ...
...
class ToDictVisitor(Visitor):
    ...
    def visit_SRE_Pattern(self, obj): # -> Generator[Visited, Any, None]:
        ...
